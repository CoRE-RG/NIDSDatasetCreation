...
#include <nidsdatasetcreation/linklayer/ethernet/modular/CorruptEthernetMacLayer.h>
...
Define_Module(CorruptEthernetMacLayer);

void CorruptEthernetMacLayer::initialize(int stage)
{
...
void CorruptEthernetMacLayer::receiveSignal(cComponent *source, simsignal_t signal, cObject *object, cObject *details)
{
